...
```{r}
ind_2 <- which(murder_rate < 1) 
  
ind_2
ind <- which(murders$state == "Minnesota")
ind # this is the index that matches the Minnesota entry
